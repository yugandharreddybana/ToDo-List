...
router.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get('/api/goals', { params: req.query });
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.post('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).post('/api/goals', req.body);
...
router.get('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get(`/api/goals/${req.params.id}`);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.put('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).put(`/api/goals/${req.params.id}`, req.body);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.patch('/:id/progress', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).patch(`/api/goals/${req.params.id}/progress`, req.body);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.delete('/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    await client(req).delete(`/api/goals/${req.params.id}`);
    res.status(204).end();
  } catch (err) {
    next(err);
  }
...
router.get('/:id/milestones', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get(`/api/goals/${req.params.id}/milestones`);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.post('/:id/milestones', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).post(`/api/goals/${req.params.id}/milestones`, req.body);
    res.status(201).json(data);
  } catch (err) {
    next(err);
  }
...
router.patch('/:goalId/milestones/:milestoneId', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).patch(
      `/api/goals/${req.params.goalId}/milestones/${req.params.milestoneId}`,
      req.body,
    );
    res.json(data);
  } catch (err) {
