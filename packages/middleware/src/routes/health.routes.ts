...
router.get('/logs', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get('/api/health/logs', { params: req.query });
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.post('/logs', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).post('/api/health/logs', req.body);
...
router.put('/logs/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).put(`/api/health/logs/${req.params.id}`, req.body);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.delete('/logs/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    await client(req).delete(`/api/health/logs/${req.params.id}`);
    res.status(204).end();
  } catch (err) {
    next(err);
  }
...
router.get('/habits', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get('/api/health/habits');
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.post('/habits', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).post('/api/health/habits', req.body);
    res.status(201).json(data);
  } catch (err) {
    next(err);
  }
...
router.put('/habits/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).put(`/api/health/habits/${req.params.id}`, req.body);
    res.json(data);
  } catch (err) {
    next(err);
  }
...
router.delete('/habits/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    await client(req).delete(`/api/health/habits/${req.params.id}`);
    res.status(204).end();
  } catch (err) {
    next(err);
  }
...
router.get('/habits/:id/logs', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).get(`/api/health/habits/${req.params.id}/logs`, {
      params: req.query,
    });
    res.json(data);
  } catch (err) {
...
router.post('/habits/:id/logs', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { data } = await client(req).post(
      `/api/health/habits/${req.params.id}/logs`,
      req.body,
    );
    res.status(201).json(data);
  } catch (err) {
